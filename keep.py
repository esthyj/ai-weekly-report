...
def set_textbox_from_summarizedtxt(pptx_in: str, pptx_out: str, text: str, shape_index: int = 15, slide_index: int = 0):
...
if __name__ == "__main__":
    # 먼저 shape 목록 확인 (디버깅용)
    # list_all_shapes("input.pptx")
    
    # 슬라이드 0의 15번째 shape에 텍스트 삽입
    set_textbox_from_summarizedtxt(
